...
<body>
<spr:form action="add_prod_form.htm" method="post" commandName="prod" >
...
<div class="login" style="margin-top:80px;">
	<table align="center" style="margin-top: 5px;" >
		...
		<tr>
			...
			<td>
				<spr:select path="category" style="height:30px; border-radius:5%; margin-bottom:10px;">
					<spr:option value="TV"></spr:option>
					<spr:option value="Laptop"></spr:option>
					<spr:option value="Fridge"></spr:option>
					<spr:option value="Microwave"></spr:option>
					<spr:option value="Washing Machine"></spr:option>
				</spr:select>
			</td>
		</tr>
